...
from graph.edges.conditions.search_conditions import decide_rag_path, decide_search_type, transform_query_search
from graph.edges.conditions.generation_conditions import decide_generation_type, decide_to_generate
...
class RAGWorkflowBuilder:
    ...
    def create_full_workflow() -> WorkflowBuilder:
        ...
        # Grading decision - using old logic
        builder.add_conditional_edge(
            "grade_documents",
            decide_to_generate,
            {
        ...
        # Transform query loop back - using old logic
        builder.add_conditional_edge(
            "transform_query",
            transform_query_search,
            {
                "check_required_search": "check_required_search",
                "end": "end"
            }
